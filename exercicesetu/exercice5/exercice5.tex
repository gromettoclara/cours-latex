...
%rajouter les packages nécessaires
...
%  Citation un peu plus longue à mettre dans l'environnement adapté.
...
\section{quotation}
% Citation de plusieurs paragraphes à mettre dans l'environnement adapté
