...
%Numérotez les lignes en enlevant les commentaires de \beginnumbering, \pstart, \pend et \endnumbering sur la partie en ancien français
%Décommentez les notes pour ajouter l'apparat de notes
%Décomentez les commentaires de \beginnumbering, \pstart, \pend et \endnumbering sur la partie en français moderne pour imprimer la traduction
%Mettez le texte dans un environnement Leftside (attention à la majuscule), et sa traduction (décommentée) dans un environnement Rightside; puis mettre tout ça dans un environnement pages, et ajoutez après la fermeture de cet environnement la commande \Pages
%Transformez pages en pairs, et \Pages en \Columns
