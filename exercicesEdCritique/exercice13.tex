...
\usepackage[greek,latin,french]{babel}
...
%2. déclarer un shorthand pour les codex P et R, qui sont les codex principaux, il suffit d'afficher codd. en italique
%syntaxe : \DeclareShorthand{identifiant}{texte à afficher}{témoins désignés}
